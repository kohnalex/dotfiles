...
_G.packer_plugins = {
  ...
  ["lexima.vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/lexima.vim",
  ...
  ["papercolor-theme"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/papercolor-theme",
  ...
  ["vim-sleuth"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/vim-sleuth",
